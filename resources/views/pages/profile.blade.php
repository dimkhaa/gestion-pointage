          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              <div class="text-center">
                <h3>
                    {{$userLogin->prenom}} {{$userLogin->nom}} @if($userLogin->age!=null) <span class="font-weight-light">  , {{$userLogin->age}} </span> @endif
                </h3>
          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative"
                             placeholder="First name" value="{{$userLogin->prenom}}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-last-name" class="form-control form-control-alternative"
                         placeholder="Last name" value="{{$userLogin->nom}}">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="input-email" class="form-control form-control-alternative"
                         placeholder="jess@xxx.com" value="{{$userLogin->email}}">
                      </div>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
                <!-- Address -->
                <h6 class="heading-small text-muted mb-4">Information Contact</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
